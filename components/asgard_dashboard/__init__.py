...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional("z1_feed_temp_id"):                    cv.use_id(sensor.Sensor),
        cv.Optional("z1_return_temp_id"):                  cv.use_id(sensor.Sensor),
        ...
        cv.Optional("num_hysteresis_up_z1_id"):            cv.use_id(number.Number),
        ...
        cv.Optional("buffer_thermostat_climate_id"):       cv.use_id(climate.Climate),
        cv.Optional("secondary_pump_demand_id"):           cv.use_id(binary_sensor.BinarySensor),
        cv.Optional("num_buffer_hysteresis_id"):           cv.use_id(number.Number),
...
async def to_code(config):
    ...
    pairs = [
        ...
        ("z1_feed_temp_id",                   "set_z1_feed_temp"),
        ("z1_return_temp_id",                 "set_z1_return_temp"),
        ...
        ("num_hysteresis_up_z1_id",           "set_num_hysteresis_up_z1"),
        ...
        ("buffer_thermostat_climate_id",      "set_buffer_thermostat_climate"),
        ("secondary_pump_demand_id",          "set_secondary_pump_demand"),
        ("num_buffer_hysteresis_id",          "set_num_buffer_hysteresis"),
